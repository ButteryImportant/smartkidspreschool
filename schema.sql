-- ============================================================================
-- Smart Kids Preschool & Daycare - Cloudflare D1 Database Schema
-- Production Serverless SQLite Schema
-- ============================================================================

-- 1. Administrators & Parent User Accounts
CREATE TABLE IF NOT EXISTS users (
  ...
  role TEXT NOT NULL DEFAULT 'parent', -- 'admin' | 'parent' | 'teacher'
  phone TEXT,
  student_id TEXT,
  avatar TEXT DEFAULT '👨‍💼',
...
CREATE TABLE IF NOT EXISTS students (
  ...
  fee_status TEXT DEFAULT 'Unassigned', -- 'Paid' | 'Pending' | 'Overdue' | 'Unassigned'
  fee_due INTEGER DEFAULT 0,
  term TEXT DEFAULT '2026-27',
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP
);

-- 3. Student Assessment & Report Cards
CREATE TABLE IF NOT EXISTS report_cards (
  id TEXT PRIMARY KEY,
  student_id TEXT NOT NULL,
  term TEXT NOT NULL, -- 'Term 1' | 'Term 2' | 'Annual Assessment'
  academic_year TEXT DEFAULT '2026-27',
  grades_json TEXT NOT NULL, -- JSON array of subjects & evaluation grades
  teacher_remarks TEXT,
  published_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (student_id) REFERENCES students(id) ON DELETE CASCADE
);

-- 4. Fee Invoices & Payment Transactions
CREATE TABLE IF NOT EXISTS transactions (
  ...
  fee_type TEXT NOT NULL, -- 'Admission Fee' | 'Term 1 Fee' | 'Term 2 Fee' | 'Daycare Monthly'
...
-- 5. Online Admission Inquiries & Applications
CREATE TABLE IF NOT EXISTS admissions (
  ...
  program TEXT NOT NULL, -- 'Playgroup' | 'Nursery' | 'Junior KG' | 'Senior KG' | 'Daycare'
  academic_year TEXT DEFAULT '2026-27',
  status TEXT DEFAULT 'Under Review', -- 'Under Review' | 'Accepted' | 'Waitlisted' | 'Enrolled'
  notes TEXT,
  submitted_at DATETIME DEFAULT CURRENT_TIMESTAMP
);

-- 6. School Bulletins & Announcements
...
-- 7. Email OTP Verification Tokens
...
-- ============================================================================
-- Seed Initial Administrator Accounts (Manisha & Hardik)
-- ============================================================================
